...
class ErrorMessageUITests: XCTestCase {
   ...
   func testPortfolioDuplicateTickerSymbolError() {
      ...
      XCTAssertFalse(addPositionAlertView.exists, "Add Position alert view still exists.")
      expectation(for: NSPredicate(format: "exists == 1"), evaluatedWith: duplicateTickerSymbolAlertView)
      waitForExpectations(timeout: 5)
      XCTAssertTrue(duplicateTickerSymbolAlertView.exists, "Duplicate Ticker Symbol alert view does not exist.")
      XCTAssertTrue(appWindow.frame.contains(duplicateTickerSymbolAlertView.frame),
                    "Duplicate Ticker Symbol alert view is not visible.")
   ...
   func testPortfolioInvalidTickerSymbolError() {
      ...
      XCTAssertFalse(addPositionAlertView.exists, "Add Position alert view still exists.")
      expectation(for: NSPredicate(format: "exists == 1"), evaluatedWith: invalidTickerSymbolAlertView)
      waitForExpectations(timeout: 5)
      XCTAssertTrue(invalidTickerSymbolAlertView.exists, "Invalid Ticker Symbol alert view does not exist.")
      XCTAssertTrue(appWindow.frame.contains(invalidTickerSymbolAlertView.frame),
                    "Invalid Ticker Symbol alert view is not visible.")
   ...
   func testPortfolioInvalidShareCount() {
      ...
      XCTAssertFalse(addPositionAlertView.exists, "Add Position alert view still exists.")
      expectation(for: NSPredicate(format: "exists == 1"), evaluatedWith: invalidShareCountAlertView)
      waitForExpectations(timeout: 5)
      XCTAssertTrue(invalidShareCountAlertView.exists, "Invalid Share Count alert view does not exist.")
      XCTAssertTrue(appWindow.frame.contains(invalidShareCountAlertView.frame),
                    "Invalid Share Count alert view is not visible.")
