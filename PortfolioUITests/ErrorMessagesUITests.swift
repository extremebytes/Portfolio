...
class ErrorMessageUITests: XCTestCase {
   ...
   func testPortfolioCreationError() {
      ...
      expectationForPredicate(NSPredicate(format: "exists == 1"), evaluatedWithObject: creationErrorAlertView, handler: nil)
      waitForExpectationsWithTimeout(5, handler: nil)
      XCTAssertTrue(creationErrorAlertView.exists, "Creation Error alert view does not exist.")
      XCTAssertTrue(CGRectContainsRect(appWindow.frame, creationErrorAlertView.frame), "Creation Error alert view is not visible.")
   ...
   func testPortfolioDuplicateTickerSymbolError() {
      ...
      XCTAssertFalse(addPositionAlertView.exists, "Add Position alert view still exists.")
      expectationForPredicate(NSPredicate(format: "exists == 1"), evaluatedWithObject: duplicateTickerSymbolAlertView, handler: nil)
      waitForExpectationsWithTimeout(5, handler: nil)
      XCTAssertTrue(duplicateTickerSymbolAlertView.exists, "Duplicate Ticker Symbol alert view does not exist.")
      XCTAssertTrue(CGRectContainsRect(appWindow.frame, duplicateTickerSymbolAlertView.frame), "Duplicate Ticker Symbol alert view is not visible.")
   ...
   func testPortfolioInvalidTickerSymbolError() {
      ...
      XCTAssertFalse(addPositionAlertView.exists, "Add Position alert view still exists.")
      expectationForPredicate(NSPredicate(format: "exists == 1"), evaluatedWithObject: invalidTickerSymbolAlertView, handler: nil)
      waitForExpectationsWithTimeout(5, handler: nil)
      XCTAssertTrue(invalidTickerSymbolAlertView.exists, "Invalid Ticker Symbol alert view does not exist.")
      XCTAssertTrue(CGRectContainsRect(appWindow.frame, invalidTickerSymbolAlertView.frame), "Invalid Ticker Symbol alert view is not visible.")
   ...
   func testPortfolioInvalidShareCount() {
      ...
      XCTAssertFalse(addPositionAlertView.exists, "Add Position alert view still exists.")
      expectationForPredicate(NSPredicate(format: "exists == 1"), evaluatedWithObject: invalidShareCountAlertView, handler: nil)
      waitForExpectationsWithTimeout(5, handler: nil)
      XCTAssertTrue(invalidShareCountAlertView.exists, "Invalid Share Count alert view does not exist.")
      XCTAssertTrue(CGRectContainsRect(appWindow.frame, invalidShareCountAlertView.frame), "Invalid Share Count alert view is not visible.")
